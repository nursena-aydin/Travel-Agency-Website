...
<head>
   ...
   <title>Gezinti - Yönetici Sayfası</title>
...
<div class="container-fluid bg-dark px-5 d-none d-lg-block">
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-5 mb-5 giris-header">
            ...
            <h1 class="display-3 text-white animated slideInDown">Bütün Rezervasyonlar</h1>
            <table id="customers">
                <tr>
            ...
            $sec="SELECT * FROM booking";

            $sonuc = $conn->query($sec);

            if ($sonuc->num_rows>0) {
                while ($cek = $sonuc->fetch_assoc()) {   echo "
                        <tr>
                        <td>".$cek['booking_id']."</td>
                        <td>".$cek['name']."</td>
                        <td>".$cek['email']."</td>
                        <td>".$cek['date']."</td>
                        <td>".$cek['destination']."</td>
                        <td>".$cek['requests']."</td>
                        </tr>
                ";                 
                }
